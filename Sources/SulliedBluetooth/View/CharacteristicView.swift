...
struct CharacteristicView_Previews: PreviewProvider {
    static var previews: some View {
        VStack {
            CharacteristicView(model: CharacteristicModel(uuid: CBUUID(string: "0x2a37"), properties: [.notify], value: [0x10, 0xa0, 0x00, 0x04, 0x00, 0x03].withUnsafeBufferPointer({ Data($0) }))) { _, _ in }
